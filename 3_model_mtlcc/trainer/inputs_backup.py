...
class Dataset():
  ...
  def Copernicusnew_all(self, feature):
  ...
  def Copernicusnew_cebf(self, feature):
  ...
  def create_tf_dataset(self, partition, fold, batchsize, shuffle, prefetch_batches=None, num_batches=-1, threads=8,
    ...
    def mapping_function(serialized_feature):
      ...
      if self.reference == "Copernicusnew_all": feature = self.Copernicusnew_all(feature)
      if self.reference == "Copernicusnew_cebf": feature = self.Copernicusnew_cebf(feature)
