...
def merge_fn(ds_250m_spectral, ds_500m_spectral, ds_250m_aux, bands_250m_spectral, bands_500m_spectral, bands_250m_aux, version_discrete, version_continuous, tfiles, psize, timesteps, batchsize, project):
    ...
    with tf.Session(config=config) as sess:
        ...
        for t in range(int(nfiles)):
            ...
            labels_mapbiomas = np.argmax(labels_continuous, axis=3)
...
if __name__ == '__main__':
    ...
    version_discrete = ['MCD12Q1v6raw_LCType1', 'MCD12Q1v6_LCType1', 'MCD12Q1v6raw_LCProp1', 'MCD12Q1v6_LCProp1', 'MCD12Q1v6raw_LCProp2', 'MCD12Q1v6_LCProp2', 'ESAraw', 'Copernicusraw', 'Copernicusnew_all2ofu', 'Copernicusnew_cebf2ofu', 'Copernicusnew_all2ofg']

    if project.startswith("tile_"):
        v_start = ['mapbiomas']
        v_end = ['mapbiomas_' + str(i) for i in range(1,5,1)]
