...
calc_seq <- function(scheme, dataset, terrai_target, lc_target){
...
<<<<<<< HEAD
<<<<<<< HEAD
  terrai_file <- 'T:/GISDATA_terra/outputs/Latin/2004_01_01_to_2019_08_13/TIFF/decrease/region/classified/latin_decrease_2004_01_01_to_2019_08_13.tif'
=======
  terrai_file <- 'T:/GISDATA_terra/outputs/Latin/2004_01_01_to_2019_08_13/TIFF/GEOGRAPHIC/WGS84/decrease/region_lat/classified/latin_decrease_2004_01_01_to_2019_08_13.tif'
>>>>>>> origin/master
=======
  terrai_file <- 'T:/GISDATA_terra/outputs/Latin/2004_01_01_to_2019_08_13/TIFF/GEOGRAPHIC/WGS84/decrease/region_lat/classified/latin_decrease_2004_01_01_to_2019_08_13.tif'
>>>>>>> origin/master
  ...
  png(filename=paste0(chart_dir,"/terrai_",Syear_terrai,"to",Eyear,"_convgru64_15_fold0_",dataset,"_",ckpt,"_",trat,".png"))
...
=======
      global_colors = c('#086a10','#54a708', '#ffbb22','#ffff4c','#0096a0','#b4b4b4','#f096ff','#fa0000')
    }   
=======
      global_colors = c('#086a10','#54a708', '#ffbb22','#ffff4c','#0096a0','#b4b4b4','#f096ff','#fa0000')
    }   
...
plot_seq <- function(dataset, results_df, sizew, sizeh){
  ...
  png(filename=paste0(chart_dir,"/seqcommon_convgru64_15_fold0_",dataset,"_",ckpt,"_",trat,".png"), width = sizew, height = sizeh, units = "px",  antialias = "cleartype")
  # Plot the 10 most frequent sequences.
  par(mar = c(2, 4, 2, 2), cex.lab = 1.1) 
  seqfplot(tab.seq, with.legend = F, border = NA, main="Most common LC sequences", legend.prop=0.2)
  dev.off()
  
  png(filename=paste0(chart_dir,"/seqdistribution_convgru64_15_fold0_",dataset,"_",ckpt,"_",trat,".png"), width = sizew, height = sizeh, units = "px",  antialias = "cleartype")
  #par(omi=c(0,0,0,0), mgp=c(0,0,0),mar=c(0,0,0,0) , family = "D")
  par(mar = c(2, 5, 2, 1), cex.lab = 1.1) 
  seqdplot(tab.seq, with.legend = F, border = NA,main="LC distribution over time", ylab=paste0("Fraction [0-1] of Terra-i's det ",paste(terrai_target_years,collapse=" to ")), legend.prop=0.2)
  dev.off()
  
  png(filename=paste0(chart_dir,"/seqall_convgru64_15_fold0_",dataset,"_",ckpt,"_",trat,".png"), width = sizew, height = sizeh, units = "px",  antialias = "cleartype")
  #par(omi=c(0,0,0,0), mgp=c(0,0,0),mar=c(0,0,0,0) , family = "D")
  par(mar = c(2, 5, 2, 1), cex.lab = 1.1) 
  seqplot(tab.seq, type="I", sortv = "from.start", main="Most common LC sequences", border = NA, with.legend = FALSE, legend.prop=0.2)
  dev.off()
  
  #layout(matrix(c(1, 2, 2, 3:5), ncol=3, byrow=TRUE))
  tab_all <- apply(tab.seq, 1 , paste , collapse = "-") 
  common = mcr(tab.seq)
  tab.clean = tab.seq[!tab_all==common,]
  
  png(filename=paste0(chart_dir,"/seqcommonclean_convgru64_15_fold0_",dataset,"_",ckpt,"_",trat,".png"), width = sizew, height = sizeh, units = "px",  antialias = "cleartype")
  # Plot the 10 most frequent sequences removing dominant
  par(mar = c(2, 4, 2, 2), cex.lab = 1.1) 
  seqfplot(tab.clean, with.legend = F, border = NA, main="Most common LC sequences wo dominant", legend.prop=0.2)
  dev.off()
  
  png(filename=paste0(chart_dir,"/seqallclean_convgru64_15_fold0_",dataset,"_",ckpt,"_",trat,".png"), width = sizew, height = sizeh, units = "px",  antialias = "cleartype")
  #par(omi=c(0,0,0,0), mgp=c(0,0,0),mar=c(0,0,0,0) , family = "D")
  par(mar = c(2, 5, 2, 1), cex.lab = 1.1) 
  seqplot(tab.clean, type="I", sortv = "from.start", main="Most common LC sequences", border = NA, with.legend = FALSE, legend.prop=0.2)
  dev.off()
  ...
  par(mar = c(4, 5, 4, 1), cex.axis = 0.75, cex.main = 2.2, cex.lab=2, mai = c(0.8, 0.6, 0.8, 0.6))
  seqdplot(tab.seq.s, with.legend = F, border = NA,main="LC distribution over time", ylab=paste0("Fraction [0-1] of Terra-i's det ",paste(terrai_target_years,collapse=" to ")), legend.prop=0.2, cex.axis=1.8)
  seqfplot(tab.seq, with.legend = F, border = NA, main="Most common LC sequences incl. dominant", legend.prop=0.2, cex.axis=1.8)
  seqfplot(tab.clean, with.legend = F, border = NA, main="Most common LC sequences excl. dominant", legend.prop=0.2, cex.axis=1.8)
  #seqplot(tab.seq, type="I", sortv = "from.start", main="LC sequences incl. dominant", border = NA, with.legend = FALSE, legend.prop=0.2)
  #seqplot(tab.clean, type="I", sortv = "from.start", main="LC sequences excl. dominant", border = NA, with.legend = FALSE, legend.prop=0.2)
...
for (d in datasets){
  ...
  if (trat == 'prediction'){
    ...
    # raw files
    dir <- paste0("E:/acocac/research/",tile,"/eval/pred/1_dataset/ep",epochs,"/convgru/convgru64_15_fold0_",d,"_",ckpt)
    pattern <- "prediction"
  }
  
  results <- calc_seq(scheme, d, terrai_target_years, lc_target_years)  
  output <- plot_seq(d, results, 1324, 361)
}
