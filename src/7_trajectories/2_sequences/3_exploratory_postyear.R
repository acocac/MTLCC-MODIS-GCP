...
png(filename=paste0(chart_dir,"/tentropy_",tyear,".png"), width = 300, height = 250, units='mm', res=70)
seqHtplot(tab.target.metrics, main = "Entropy", ylab="Entropy index value",xlab=("Time"), legend.prop=0.2)
dev.off()

png(filename=paste0(chart_dir,"/permanence_",tyear,".png"), width = 300, height = 250, units='mm', res=70)
