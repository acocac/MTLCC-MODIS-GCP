"""
Hyper-parameter tuning of shallow learner models using a local machine

Example invocation::

    python 4_shallowlearners/train-hpt.py MODELDIR
        -c RF
        -d DATADIR
        -y 2001
        -s 3000
...
def parse_arguments(argv):
	...
	parser.add_argument('-n','-cpus', '--cpus', type=int, default=14,
						help='cpus')
	parser.add_argument('-t','-num_eval', '--num_eval', type=int, default=5,
